...
public class FormQuetQRHD extends javax.swing.JDialog implements Runnable, ThreadFactory {
    ...
    public FormQuetQRHD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initWebcam();
    ...
    public void run() {
        do {
            ...
            if (result != null) {
                ...
                Form_Hoa_Don.maHD = result.getText();
                webcam1.close();
                return;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormQuetQRHD dialog = new FormQuetQRHD(new javax.swing.JFrame(), true);
