...
public class FormAddKichThuoc extends javax.swing.JDialog {

    private final ThuocTinhDAO dataTT = new ThuocTinhDAO();
    public String code;

    public FormAddKichThuoc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnThem.setText("Thêm kích thước");
        ...
        txtTenThuocTinh.setLabelText("Kích thước");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormAddKichThuoc dialog = new FormAddKichThuoc(new javax.swing.JFrame(), true);
