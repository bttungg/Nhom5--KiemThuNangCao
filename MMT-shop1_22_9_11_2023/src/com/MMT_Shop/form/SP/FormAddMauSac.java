...
public class FormAddMauSac extends javax.swing.JDialog {

    private final ThuocTinhDAO dataTT = new ThuocTinhDAO();
    public String code;

    public FormAddMauSac(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtTenThuocTinh.setLabelText("Màu Sắc");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormAddMauSac dialog = new FormAddMauSac(new javax.swing.JFrame(), true);
