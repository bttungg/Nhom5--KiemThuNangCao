...
public class FormAddLoaiKhung extends javax.swing.JDialog {

    private final ThuocTinhDAO dataTT = new ThuocTinhDAO();
    public String code;

    public FormAddLoaiKhung(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnThem.setText("Thêm loại khung");
        ...
        txtTenThuocTinh.setLabelText("Loại khung");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormAddLoaiKhung dialog = new FormAddLoaiKhung(new javax.swing.JFrame(), true);
