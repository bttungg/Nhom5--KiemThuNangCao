...
public class FormQuetQRBH extends javax.swing.JDialog implements Runnable, ThreadFactory {
    ...
    public FormQuetQRBH(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initWebcam();
    ...
    public void run() {
        do {
            ...
            if (result != null) {
                ...
                webcam1.close();
                Form_Ban_Hang.maSPCT = result.getText();
...
//                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormQuetQRBH dialog = new FormQuetQRBH(new javax.swing.JFrame(), true);
