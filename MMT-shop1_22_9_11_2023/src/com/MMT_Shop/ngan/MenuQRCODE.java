...
public class MenuQRCODE extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuQRCODE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MenuQRCODE().setVisible(true);
        });
    }
