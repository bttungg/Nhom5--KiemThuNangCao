package com.MMT_Shop.swing.chart;

import com.MMT_Shop.model.ModelChart;
import com.MMT_Shop.swing.chart.blankchart.BlankPlotChart;
import com.MMT_Shop.swing.chart.blankchart.BlankPlotChatRender;
import com.MMT_Shop.swing.chart.blankchart.SeriesSize;
...
public class Chart extends javax.swing.JPanel {
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotChatRender() {
            ...
            public void renderSeries(BlankPlotChart chart, Graphics2D g2, SeriesSize size, int index) {
                ...
                for (int i = 0; i < legends.size(); i++) {
                    ...
                    GradientPaint gra = new GradientPaint(0, 0, new Color(25, 237, 108), 0, (int)(size.getY()+size.getHeight()), legend.getColor());
                    g2.setPaint(gra);
    ...
    private void initComponents() {
        ...
        blankPlotChart = new com.MMT_Shop.swing.chart.blankchart.BlankPlotChart();
    ...
    private com.MMT_Shop.swing.chart.blankchart.BlankPlotChart blankPlotChart;
